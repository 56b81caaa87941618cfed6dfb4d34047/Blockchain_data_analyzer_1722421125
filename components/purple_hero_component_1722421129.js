        ...
        <div id="section-container" class="relative max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="hero-content-container" class="pt-32 pb-16 md:pt-52 md:pb-32">
                ...
                <div id="hero-content" class="max-w-3xl mx-auto text-center" style="position: relative;z-index: 1">
                    ...
                    <div class="flex" id="hero-text-container"><h1 id="hero-text" class="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Gain Deep Insights into Blockchain Data</h1></div>
                    <div class="flex" id="sub-hero-text-container"><p id="sub-hero-text" class="flex-1 text-lg mb-8" data-aos="fade-down" data-aos-delay="200" :class="landingPageSubHeroTextStyle">Our powerful analysis engine helps you uncover valuable patterns and trends within the blockchain ecosystem.</p></div>
                    ...
                    <div id="hello-world-button-container" class="flex mt-4">
                        <button id="hello-world-button" class="flex-1 btn bg-blue-500 hover:bg-blue-600 text-white w-full transition duration-150 ease-in-out rounded-md shadow-md px-4 py-2">
                            Hello World
                        </button>
                    </div>
